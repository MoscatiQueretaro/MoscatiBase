package org.iconotecnologies.damner.web.rest.agora.rtm;

import org.iconotecnologies.damner.web.rest.agora.media.AccessToken;
...
public class RtmTokenBuilder {
    ...
    public String buildToken(String appId, String appCertificate, String uid, Role role, int privilegeTs) throws Exception {
